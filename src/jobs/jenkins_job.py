...
class OpenEulerJenkinsJobs(JenkinsJobs):
    """
    openEuler 仓库
    TODO...
    """
    def get_real_target_jobs(self, jobs):
        super(OpenEulerJenkinsJobs, self).get_real_target_jobs(jobs)
...
if "__main__" == __name__:
    ...
    args.add_argument("-a", type=str, dest="action", help="workspace where to find source")
    ...
    args.add_argument("-x", type=str, dest="buddy_info_file", help="src-openeuler buddy info file")
    ...
    jenkins_jobs = SrcOpenEulerJenkinsJobs(args.template_job, jp_m, args.buddy_info_file, args.exclusive_arch_file)
