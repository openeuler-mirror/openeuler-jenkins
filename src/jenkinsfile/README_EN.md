...
>
> The script name must be the same as the repository name and can contain the suffix corresponding to the language.
>
> Currently, the **aarch64, x86-64, and risc-v** architectures are supported.
